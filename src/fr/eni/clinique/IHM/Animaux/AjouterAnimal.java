 ...
 */
public class AjouterAnimal extends JDialog {
    public AjouterAnimal(Frame owner) {
        super(owner);
        initComponents();
    }

    public AjouterAnimal(Frame owner, GestionClientController gestionClientController) {
        super(owner);
